from sqlalchemy import Column, Text, Integer, ForeignKey, relationship
...
class Customers(Base):
    ...
    jasmine_rice_sales = relationship("JasmineRiceSale", back_populates="costumer", cascade="all, delete-orphan")
...
class JasmineRiceSale(Base):
    ...
    customer_id = Column(Integer, ForeignKey("customer_account.id"), nullable=False)
